...
public:	
	...
	NetVariableType* pattern;	//input patterns
	NetVariableType* target;		//target result

public:	

	dataEntry(NetVariableType* p, NetVariableType* t): pattern(p), target(t) {}
...
private:
	...
	NetVariableType growingStepSize;			//step size - percentage of total set
...
public:
	...
	void setCreationApproach( int approach, NetVariableType param1 = -1, NetVariableType param2 = -1 );
